...
<t:genericpage>
    ...
    <jsp:body>
        ...
        <form name="registerForm" action="/do/register" method="post">
            ...
            <input type="text" id="login" placeholder="Enter login" value="" required> (in range 3-12
            symbols)<br><br>
            ...
            <input type="password" id="password2" value="" placeholder="Reenter password" required><br><br>
